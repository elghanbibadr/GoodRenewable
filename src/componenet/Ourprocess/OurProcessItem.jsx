...
const OurProcessItem = (props) => {
  return (
    <Gridx2>
      ...
      <img data-aos={`${props.id == 2 ? "fade-right" : "fade-left"}`} className={`${props.id == 2 ? "col-start-1 row-start-2  " : ""}  w-[70%]  mx-auto mt-12 mb-12 lg:w-[60%]`} src={props.img} loading="lazy" alt={`${props.title} svg logo presentation`} />
    </Gridx2>
  )
}
