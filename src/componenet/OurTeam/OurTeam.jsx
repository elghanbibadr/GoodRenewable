...
const OurTeam = () => {
  ...
  return (
    <div className='mt-20 lg:my-40 mb-40  mx-auto '>
    ...
    {TeamData.map(({id,name,role,img,href,animation})=>{
        return <Card animation={animation} key={id} className="text-center rounded-[16px] max-w-[348px] mx-auto flex flex-col items-center justify-between  h-[52rem] p-4 my-4">
            <img className='w-[40%] lg:w-[60%] my-6  mx-auto' src={img} />
            <h5>{name}</h5>
            <p className='px-8  lg:text-[1.7rem] lg:relative lg:bottom-5'>{role}</p>
